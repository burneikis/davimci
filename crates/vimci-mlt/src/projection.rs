...
use vimci_core::{Clip, ClipId, Frame, Timeline, TimelineProps, TrackId, TrackKind};
...
mod tests {
    ...
    fn offline_media_projects_to_a_visible_placeholder() {
        let mut tl = vimci_core::testing::media_fixture(&[(0, 10, 0, 100)]);
    ...
    fn solo_mutes_every_other_track() {
        ...
        let a1 = vimci_core::testing::track_id(&tl, "A1");
    ...
    fn gain_becomes_a_volume_filter_and_zero_gain_becomes_nothing() {
        ...
        let track = vimci_core::testing::track_id(&tl, "A1");
        let clip = vimci_core::testing::clip_ids(&tl, "A1")[0];
        let a1_index = 1;
        assert!(
