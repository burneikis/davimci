...
pub struct ImportOptions {
    ...
    pub at: Frame,
    /// Whether landing clips push later ones right or sit on
...
pub enum Placement {
    ...
    #[default]
    Overwrite,
    /// Push later clips right by the imported length.
    Insert,
}

/// Which track a source stream ended up on.
...
pub struct Imported {
    ...
    pub length: Frame,
    /// True when the timeline adopted this file's properties.
...
pub fn plan(
    ...
    // An empty timeline takes its properties from the first import.
