...
//!
//! Every mutation of a [`Timeline`] outside `vimci-core`'s own tests goes
...
mod tests {
    ...
    use vimci_core::{ClipProps, MediaRef, TimelineProps};
    ...
    fn media_clips_survive_a_delete_and_restore_unchanged() {
        ...
        let media = MediaRef::new("/m.mkv", vimci_core::Fps::FPS_60, Frame(600));
