...
//!
//! Hand-written rather than bindgen-generated: vimci uses a small, stable
...
//! live one layer up in `vimci-mlt`; nothing else in the workspace may depend
...
/// presenter's format, so this is the only one vimci ever asks for.
