//! The trim family: ripple trim, roll, slip, slide.
//!
...
impl Timeline {
    /// Ripple trim: move one edge, shift later clips so no
    ...
    /// Roll: move a cut point; both neighbours absorb the
    ...
    /// Slip: change a clip's source in/out points without
    ...
    /// Slide: move a clip along the timeline; the
