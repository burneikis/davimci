//! Tracks: ordered, non-overlapping sequences of clips.
...
impl Track {
    ...
    ///
    /// The overlap is made of handle frames, so this is where the transition's
    ...
    /// Structural invariants for one track.
